        ...
        <div className="md:col-span-2 space-y-8">
          ...
          <Card id="terms" className="scroll-mt-8">
            ...
            <CardContent className="pt-6 space-y-6">
              <p>Welcome to SEND US MONEY LLC. By accessing or using our mobile application or website ("Platform"), 
              you agree to be bound by these Terms of Use. If you do not agree, do not use our Platform.</p>
              ...
              <div className="space-y-4">
                ...
                <p>We provide international money transfer services from the United States to select countries, along with
                access to travel, life, and commercial insurance services.</p>
                ...
                <p>You agree to provide accurate and complete information when creating your account and to keep this
                ...
                <p>All content on our Platform is the property of SEND US MONEY LLC and is protected by intellectual property
                laws.</p>
                ...
                <p>We do not guarantee uninterrupted or error-free operation. Our liability is limited to the maximum extent
                permitted by law.</p>
          ...
          <Card id="privacy" className="scroll-mt-8">
            ...
            <CardContent className="pt-6 space-y-6">
              <p>SEND US MONEY LLC respects your privacy. This Privacy Policy explains how we collect, use, and protect
