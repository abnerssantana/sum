    ...
    <div className="min-h-screen bg-gradient-to-b from-[#d1ffd1] to-white dark:from-[#0a3a0a] dark:to-[#072007] text-[#083208] dark:text-white">
      ...
      <header className="container mx-auto py-6 px-4">
        <div className="flex items-center justify-between">
          ...
          >
            <a href="#features" className="hover:text-[#0b8b0b] transition-colors">Features</a>
            <a href="#about" className="hover:text-[#0b8b0b] transition-colors">About</a>
            <a href="#testimonials" className="hover:text-[#0b8b0b] transition-colors">Testimonials</a>
            <a href="#contact" className="hover:text-[#0b8b0b] transition-colors">Contact</a>
          </motion.nav>
      ...
      <section className="container mx-auto py-20 px-4 flex flex-col md:flex-row items-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button className="bg-[#0b8b0b] hover:bg-[#097a09] text-white px-8 py-3 rounded-full text-lg transition-colors flex items-center gap-2">
        ...
        >
          <div className="relative w-80 h-80 bg-[#e9ffe9] dark:bg-[#0f4d0f] rounded-3xl overflow-hidden shadow-2xl">
            <div className="absolute w-full h-full flex items-center justify-center">
              <DollarSign size={120} className="text-[#0b8b0b] dark:text-white" />
            </div>
            <motion.div 
              animate={{ 
                y: [0, -10, 0],
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              >
                <div className="text-[#0b8b0b] dark:text-white mb-4">{feature.icon}</div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            >
              <div className="grid grid-cols-2 gap-4">
                {[
                  { value: "Security", color: "bg-[#0b8b0b]" },
                  { value: "Transparency", color: "bg-[#0a6b0a]" },
                  { value: "Innovation", color: "bg-[#094b09]" },
                  { value: "Practicality", color: "bg-[#083b08]" },
                  { value: "Accessibility", color: "bg-[#072b07]" },
                  { value: "Inclusion", color: "bg-[#062106]" },
                ].map((item, index) => (
                  <motion.div
                    key={index}
                    initial={{ opacity: 0 }}
              ...
              >
                <div className="flex flex-col h-full">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#1c631c] dark:text-[#9ff29f]">{testimonial.location}</p>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <motion.div 
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-[#f2fff2] dark:bg-[#0a3a0a] rounded-3xl p-12 text-center shadow-xl"
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Download the App</h2>
            <p className="text-lg mb-8 max-w-2xl mx-auto text-[#1c631c] dark:text-[#9ff29f]">
              Send money smarter, safer, and faster.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-[#0b8b0b] hover:bg-[#097a09] text-white px-8 py-3 rounded-full font-bold transition-colors flex items-center justify-center gap-2">
                <span>Download on iOS</span>
              </button>
              <button className="border-2 border-[#0b8b0b] text-[#0b8b0b] dark:text-white hover:bg-[#0b8b0b]/10 px-8 py-3 rounded-full font-bold transition-colors">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between mb-8">
            <div className="mb-8 md:mb-0">
              ...
              <p className="text-sm mt-4 text-[#9ff29f]">
          ...
          <div className="border-t border-[#0b8b0b] pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-[#9ff29f] mb-4 md:mb-0">&copy; 2025 Send Us Money. All rights reserved.</p>
            <p className="text-[#9ff29f] mb-4 md:mb-0">Contact: support@sendusmoney.us</p>
            <div className="flex gap-6">
              <a href="#" className="text-[#9ff29f] hover:text-white transition-colors">
                <Twitter size={20} />
              </a>
              <a href="#" className="text-[#9ff29f] hover:text-white transition-colors">
                <Linkedin size={20} />
